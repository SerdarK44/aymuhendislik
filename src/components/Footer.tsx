...
export default function Footer({ settings, services }: { settings?: SiteSettings; services?: ServiceItem[] }) {
  ...
  return (
    <footer className="bg-ink-900 text-ink-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1 space-y-5">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a href={"https://wa.me/" + cleanWa} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-ink-800 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-all text-ink-400" aria-label="WhatsApp">
          ...
          <div>
            ...
            <div className="space-y-4 text-ink-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${cleanPhone}`} className="text-sm hover:text-white transition-colors">{phone}</a>
              </div>
              <div className="flex items-center gap-3">
      ...
      <FloatingWhatsApp phone={cleanWa} />
    </footer>
  );
}