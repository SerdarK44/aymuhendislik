...
import { MapPin, Phone, Mail, Navigation, Clock, Headphones, Share2 } from "lucide-react";
    ...
    <main className="flex-1 pt-32 pb-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {/* Google Maps Embed */}
          <FadeIn delay={0.3} className="h-full min-h-[380px] sm:min-h-[440px]">
            <div className="bg-white rounded-3xl p-2.5 border border-stone-200/80 shadow-sm h-full w-full relative overflow-hidden group">
              <iframe
                src={mapUrl}
                width="100%"
                height="100%"
                ...
                className="rounded-2xl w-full h-full min-h-[360px] sm:min-h-[420px] grayscale-[0.2] contrast-[1.05] opacity-95 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700"
              ></iframe>
            </div>
          </FadeIn>

          <FadeIn delay={0.4} className="flex flex-col gap-6 justify-between h-full">
            {/* Working Hours - Bound to CMS */}
            <div className="bg-white rounded-3xl p-6 sm:p-7 border border-stone-200/80 shadow-sm flex flex-col justify-center">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3 text-ink-900">
                  <div className="w-10 h-10 rounded-2xl bg-brand-50 border border-brand-200/60 flex items-center justify-center text-brand-600 shrink-0">
                    <Clock className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="font-bold text-sm sm:text-base text-ink-900">{isEn ? "Working Hours" : "Çalışma Saatleri"}</h3>
                    <p className="text-xs text-stone-400">{isEn ? "Office & Field Engineering" : "Merkez Ofis & Saha Operasyonu"}</p>
                  </div>
                </div>
              ...
              <div className="text-xs text-stone-600 space-y-3 pt-2">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 pb-2 border-b border-stone-100">
                  <span className="text-stone-500">{isEn ? "Standard Schedule:" : "Haftalık Mesai Saatleri:"}</span>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7 border border-stone-200/80 shadow-sm flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-4 text-ink-900">
                ...
                <div>
                  <h3 className="font-bold text-sm sm:text-base text-ink-900">{isEn ? "Connect on Social Media" : "Sosyal Medyada Biz"}</h3>
                  <p className="text-xs text-stone-400">{isEn ? "Follow our official communication channels" : "Resmi iletişim kanallarımızdan bize ulaşın"}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center justify-center gap-2 p-3 sm:py-4 rounded-2xl bg-stone-50 border border-stone-200/80 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white hover:border-transparent transition-all transform hover:-translate-y-0.5 shadow-sm text-center"
                  aria-label="Instagram"
                >
                  <div className="w-9 h-9 rounded-xl bg-white group-hover:bg-white/20 flex items-center justify-center text-stone-700 group-hover:text-white transition-colors shadow-xs">
                  ...
                  <div>
                    <span className="block text-xs font-bold text-ink-900 group-hover:text-white transition-colors">Instagram</span>
                    <span className="hidden sm:block text-[10px] text-stone-400 group-hover:text-white/80 transition-colors">@aymuhendislik</span>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center justify-center gap-2 p-3 sm:py-4 rounded-2xl bg-stone-50 border border-stone-200/80 hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] transition-all transform hover:-translate-y-0.5 shadow-sm text-center"
                  aria-label="LinkedIn"
                >
                  <div className="w-9 h-9 rounded-xl bg-white group-hover:bg-white/20 flex items-center justify-center text-stone-700 group-hover:text-white transition-colors shadow-xs">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  ...
                  <div>
                    <span className="block text-xs font-bold text-ink-900 group-hover:text-white transition-colors">LinkedIn</span>
                    <span className="hidden sm:block text-[10px] text-stone-400 group-hover:text-white/80 transition-colors">Ay Mühendislik</span>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center justify-center gap-2 p-3 sm:py-4 rounded-2xl bg-stone-50 border border-stone-200/80 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all transform hover:-translate-y-0.5 shadow-sm text-center"
                  aria-label="WhatsApp"
                >
                  <div className="w-9 h-9 rounded-xl bg-white group-hover:bg-white/20 flex items-center justify-center text-stone-700 group-hover:text-white transition-colors shadow-xs">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  ...
                  <div>
                    <span className="block text-xs font-bold text-ink-900 group-hover:text-white transition-colors">WhatsApp</span>
                    <span className="hidden sm:block text-[10px] text-stone-400 group-hover:text-white/80 transition-colors">{isEn ? "Chat Now" : "Hızlı Sohbet"}</span>
                  </div>
                </a>
              </div>
            </div>
