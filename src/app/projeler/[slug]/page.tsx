              ...
              <FadeIn delay={0.2}>
                <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-[#0b141f] to-[#050b12] text-white border border-stone-800 shadow-xl space-y-5">
                  ...
                  <div className="space-y-3 pt-2">
                    <a
                      href={`https://wa.me/${cleanWa}?text=${encodeURIComponent(`Merhaba, "${project.title}" referans projenizi inceledim. Kendi projemiz için ücretsiz keşif ve teklif almak istiyorum.`)}`}
                      target="_blank"
